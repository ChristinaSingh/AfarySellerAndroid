...
import com.afaryseller.databinding.ItemReportListBinding;
...
public class PeriodicListAdapter extends RecyclerView.Adapter<PeriodicListAdapter.MyViewHolder> {
    Context context;
    ArrayList<PeriodicReportModel.Result.OrderDetail> arrayList;


    public PeriodicListAdapter(Context context, ArrayList<PeriodicReportModel.Result.OrderDetail> arrayList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemReportListBinding binding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.item_report_list, parent, false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull ItemReportListBinding itemView) {
