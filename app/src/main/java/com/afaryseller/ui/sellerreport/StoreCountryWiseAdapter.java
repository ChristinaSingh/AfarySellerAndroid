...
public class StoreCountryWiseAdapter extends RecyclerView.Adapter<StoreCountryWiseAdapter.MyViewHolder> {
    Context context;
    ArrayList<StoreCountryWiseModel.Datum> arrayList;
    StoreListener listener;

    public StoreCountryWiseAdapter(Context context,ArrayList<StoreCountryWiseModel.Datum>arrayList,StoreListener listener) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        holder.binding.tvStore.setText(arrayList.get(position).getCountryName());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull ItemStoreBinding itemView) {
            ...
            binding.tvStore.setOnClickListener(v -> {
                listener.onStore(getAdapterPosition()+"");
            });
