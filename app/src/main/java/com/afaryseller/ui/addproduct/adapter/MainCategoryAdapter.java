...
public class MainCategoryAdapter extends RecyclerView.Adapter<MainCategoryAdapter.MyViewHolder> {
    Context context;
    ArrayList<MainCateModel.Result> arrayList;
    AddDateLister listener;

    public MainCategoryAdapter(Context context, ArrayList<MainCateModel.Result> arrayList, AddDateLister listener) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemMainCategoryBinding binding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.item_main_category, parent, false);
        return new MyViewHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        holder.binding.chkBox.setText(arrayList.get(position).getCategoryName());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull ItemMainCategoryBinding itemView) {
            ...
            binding.chkBox.setOnClickListener(v -> {
                ...
                listener.onDate("",getAdapterPosition(),"Cate",true);
            });
        }
    }
}