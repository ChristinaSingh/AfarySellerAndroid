...
public class EditTimeViewModel extends BaseViewModel {
    ...
    public void  getEditOpenTime(Context context,Map<String,String>auth,HashMap<String,String> map){
        if (NetworkAvailablity.checkNetworkStatus(context)) {
            sellerRepository.getEditOpenTimeRepo(auth,map);
        } else {
            Toast.makeText(context,"No internet connection", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void  getEditCloseTime(Context context,Map<String,String>auth,HashMap<String,String> map){
        if (NetworkAvailablity.checkNetworkStatus(context)) {
            sellerRepository.getEditCloseTimeRepo(auth,map);
        } else {
            Toast.makeText(context,"No internet connection", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void  addAOpenTime(Context context,Map<String,String>auth,HashMap<String,String> map){
        if (NetworkAvailablity.checkNetworkStatus(context)) {
            sellerRepository.UpdateOpenTimeRepo(auth,map);
        } else {
            Toast.makeText(context,"No internet connection", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void  addACloseTime(Context context,Map<String,String>auth,HashMap<String,String> map){
        if (NetworkAvailablity.checkNetworkStatus(context)) {
            sellerRepository.updateCloseTimeRepo(auth,map);
        } else {
            Toast.makeText(context,"No internet connection", Toast.LENGTH_LONG).show();
        }
    }
