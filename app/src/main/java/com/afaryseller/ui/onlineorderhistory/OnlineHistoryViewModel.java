...
public class OnlineHistoryViewModel extends BaseViewModel {
    SellerRepository sellerRepository;
    LiveData<Boolean> isLoading;
    LiveData<DynamicResponseModel> isResponse;

    public OnlineHistoryViewModel() {
    }
    ...
    public void getOnlineOrderHistory(Context context, Map<String, String> auth, HashMap<String, String> map) {
        if (NetworkAvailablity.checkNetworkStatus(context)) {
            sellerRepository.getOnlineOrderHistoryRepo(auth, map);
        } else {
